...
vim.keymap.set('n', '<leader>fr', '<CMD>FzfLua registers<CR>', { desc = 'Fzf-lua search copy register' })
vim.keymap.set('n', '<leader>dB', '<cmd>FzfLua dap_breakpoints<CR>', { desc = 'Fzf-lua search breakpoints' })
vim.keymap.set('n', '<leader>h', '<CMD>FzfLua helptags<CR>', { desc = 'Fzf-lua help' })

-- Plugins shortkeys
vim.keymap.set('n', '<leader>mp', '<CMD>MarkdownPreviewToggle<CR>', { desc = 'Markdown Preview Toggle' })
vim.cmd("packadd nvim.undotree")
vim.keymap.set('n', '<leader>u', require('undotree').open, { desc = 'Undotree Toggle' })
...
vim.keymap.set('n', '<leader>gs', '<CMD>Gitsigns toggle_current_line_blame<CR>',
	{ desc = 'Toggle Git signs on current line' })
